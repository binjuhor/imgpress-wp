...
class Config
{
    ...
    public static function defaults(): array
    {
        return [
            ...
            'optimize_js_delay_timeout' => 3500,
            'optimize_fonts_swap' => false,
            'optimize_img_lazyload' => false,
            'optimize_img_lazyload_above_fold' => 2,
            'optimize_img_add_dimensions' => false,
            'optimize_iframe_lazyload' => false,
            'optimize_html_minify' => false,
            'optimize_excluded_assets' => '',
            'bloat_disable_query_strings' => false,
            'bloat_disable_woo_cart_fragments' => false,
            'bloat_disable_heartbeat' => false,
            'bloat_disable_google_fonts' => false,
